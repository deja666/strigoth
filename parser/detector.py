"""Log format auto-detection module.

This module provides functions for automatically detecting web server log formats
(Nginx, Apache Combined, Apache Common) by analyzing log line patterns.
"""
import re
...
class LogFormat:
    """Log format enumeration constants."""
...
def detect_file_format(filepath: str) -> str:
    """Detect log format from file by reading first line.
